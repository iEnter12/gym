...
class BookingSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Booking
        fields = [
            'booking_id', 'account', 'account_username', 'account_real_name', 'account_phone',
            ...
            'duration_hours', 'reviewed', 'create_time', 'update_time'
        ]
        read_only_fields = [
    ...
    def validate(self, attrs):
        ...
        if booking_date and booking_date < tomorrow:
            raise serializers.ValidationError("只能提前一天预约，请选择明天及以后的日期")
...
class BookingListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'status', 'status_display', 'reviewed', 'create_time'
        ]
